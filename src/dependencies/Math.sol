...
library Math {
  ...
  function sqrt(uint256 a, Rounding rounding) internal pure returns (uint256) {
    unchecked {
      ...
      return
        result +
        SafeCast.toUint(unsignedRoundsUp(rounding) && result * result < a);
    }
  }
  ...
  function log2(
    ...
    unchecked {
      ...
      return
        result +
        SafeCast.toUint(unsignedRoundsUp(rounding) && 1 << result < value);
    }
  }
  ...
  function log10(
    ...
    unchecked {
      ...
      return
        result +
        SafeCast.toUint(unsignedRoundsUp(rounding) && 10 ** result < value);
    }
  }
